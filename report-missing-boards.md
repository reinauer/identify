...
* [Open an issue at Codefloe](https://codefloe.com/shred/identify/issues/new)
...
The PCI database bases on the work of [The PCI ID Repository](https://pci-ids.ucw.cz/), with Intel and AMD chipsets filtered out for file size reasons. If your PCI board is missing or wrong, please first make sure that you have installed the latest version of the PCI database. If so, please contact their project. I cannot do anything to fix that.
...
* [Eröffne einen Bug-Report bei Codefloe](https://codefloe.com/shred/identify/issues/new)
...
### Fehlende PCI-Erweiterung?

Die PCI-Datenbank basiert auf der Arbeit von [The PCI ID Repository](https://pci-ids.ucw.cz/), von der Intel- und AMD-Chipsets ausgelassen wurden, um die Dateigröße in Grenzen zu halten. Wenn deine PCI-Erweiterung fehlt oder falsch erkannt wurde, stelle zunächst sicher, dass du eine aktuelle Version der PCI-Datenbank installiert hast. Falls ja, setze dich bitte dirkte mit deren Projekt in Verbindung. Ich kann nichts daran machen.
